...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen lg:h-screen bg-black text-white lg:overflow-hidden flex flex-col pt-32 md:pt-24 pb-8 px-4 md:px-8 relative">

      {/* Red glow */}
      <div className="absolute top-0 left-0 w-full max-w-96 h-96 bg-[#e62b1e]/5 blur-[120px] rounded-full pointer-events-none" />

      {/* Header */}
      <div
        ref={headerRef}
        className="max-w-7xl w-full mx-auto mb-6 flex-shrink-0 transition-all duration-700"
        style={{
      ...
      {/* Grid */}
      <div className="max-w-7xl w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-5 flex-1 lg:min-h-0">
